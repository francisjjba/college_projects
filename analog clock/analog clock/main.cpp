...
int main(int argc, char* argv[], char* envp[]) {
	...
	glutCreateWindow("Real-Time Wall Clock : Francis & Jagadish");
...
//	glLineWidth(2.0f)
	...
	std:: string text;
	text = "3";
	drawText(text.data(), text.size(), 620, 290);
	text = "12";
	drawText(text.data(), text.size(), 390, 465);
	text = "9";
	drawText(text.data(), text.size(), 165, 290);
	text = "6";
	drawText(text.data(), text.size(), 390, 130);
